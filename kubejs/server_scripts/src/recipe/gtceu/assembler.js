...
ServerEvents.recipes(e => {
    ...
    let machine_hull = [
        ...
        ['iv', '4', 'gtceu:palladium_plate', 'gtceu:tungsten_steel_plate', 'gtceu:platinum_single_cable', 'gtceu:polytetrafluoroethylene']
    ]
    ...
    e.recipes.gtceu.assembler().itemInputs('3x gtceu:steel_turbine_blade', '4x gtceu:lv_electric_motor', '5x mekanism:ingot_steel', '3x gtceu:manasteel_rod', '16x gtceu:tin_single_cable', '4x #gtceu:circuits/lv', '3x botania:rune_air', '12x gtceu:annealed_copper_foil').itemOutputs('mekanismgenerators:wind_generator').EUt(32).duration(45 * 20).inputFluids(Fluid.of('gtceu:red_alloy', 576))
    ...
    e.recipes.gtceu.assembler().itemInputs('#oritong:planks/ass', '4x gtceu:copper_foil').itemOutputs('gtceu:resin_printed_circuit_board').EUt(7).duration(11.5 * 20).inputFluids(Fluid.of('oritong:latex', 150))
    ...
    e.recipes.gtceu.assembler().itemInputs('tconstruct:seared_bricks', '16x gtceu:stone_plate', '8x gtceu:copper_plate', Item.of('tconstruct:large_plate', '{Material:"tgears:andesite_alloy"}').strongNBT(), '6x gtceu:bronze_large_fluid_pipe', '4x gtceu:treated_wood_frame', '#forge:glass_panes/colorless', '4x #gtceu:circuits/lv').inputFluids(Fluid.of('gtceu:steel', 576)).circuit(2).itemOutputs('tconstruct:smeltery_controller').EUt(12).duration(20 * 24)
    e.recipes.gtceu.assembler().itemInputs('3x gtceu:annealed_copper_single_cable', '2x gtceu:alumina_ceramic_plate', 'gtceu:mv_machine_hull', 'gtceu:mv_voltage_coil', '2x gtceu:ulpic_chip').itemOutputs('gtceu:mv_energy_input_hatch').EUt(120).duration(200)
    ...
    e.recipes.gtceu.assembler().itemInputs('2x gtceu:steel_plate', 'gtceu:fluid_filter', '2x gtceu:mv_electric_pump', '#gtceu:circuits/hv').itemOutputs('superflatcore:basic_air_intake_cover').inputFluids(Fluid.of('gtceu:tin', 144)).duration(8 * 20).EUt(GTValues.VA[GTValues.MV] * 0.8)
    e.recipes.gtceu.assembler().itemInputs('superflatcore:basic_air_intake_cover', '2x gtceu:aluminium_plate', '2x gtceu:hv_electric_pump', '#gtceu:circuits/ev').itemOutputs('superflatcore:advanced_air_intake_cover').inputFluids(Fluid.of('gtceu:soldering_alloy', 144)).duration(8 * 20).EUt(GTValues.VA[GTValues.HV] * 0.8)
    e.recipes.gtceu.assembler().itemInputs('superflatcore:advanced_air_intake_cover', '2x gtceu:stainless_steel_plate', '2x gtceu:ev_electric_pump', '#gtceu:circuits/iv').itemOutputs('superflatcore:elite_air_intake_cover').inputFluids(Fluid.of('gtceu:ethyl_cyanoacrylate', 144)).duration(8 * 20).EUt(GTValues.VA[GTValues.EV] * 0.8).cleanroom(CleanroomType.CLEANROOM)
    e.recipes.gtceu.assembler().itemInputs('superflatcore:elite_air_intake_cover', '2x gtceu:titanium_plate', '2x gtceu:iv_electric_pump', '#gtceu:circuits/luv').itemOutputs('superflatcore:ultimate_air_intake_cover').inputFluids(Fluid.of('gtceu:ethyl_cyanoacrylate', 144)).duration(8 * 20).EUt(GTValues.VA[GTValues.IV] * 0.8).cleanroom(CleanroomType.CLEANROOM)
    e.recipes.gtceu.assembler().itemInputs('create:brass_hand', Item.of('create:copper_backtank', '{Air:900}').strongNBT(), 'superflatcore:elite_air_intake_cover', '6x gtceu:double_beryllium_copper_plate', '4x gtceu:long_stainless_steel_rod', '2x gtceu:hv_electric_piston').inputFluids(Fluid.of('gtceu:ethyl_cyanoacrylate', 288)).itemOutputs(Item.of('create:extendo_grip', '{Damage:0,Unbreakable:1}')).duration(8 * 20).EUt(GTValues.VA[GTValues.EV] * 0.8).cleanroom(CleanroomType.CLEANROOM)
    e.recipes.gtceu.assembler().itemInputs('gtceu:iv_machine_hull', '2x gtceu:iv_quantum_tank', '6x gtceu:iv_electric_motor', '4x gtceu:iv_electric_pump', '4x #gtceu:circuits/iv', '2x gtceu:osmiridium_rotor').inputFluids(Fluid.of('gtceu:ethyl_cyanoacrylate', 1000)).itemOutputs('gtceu:digester').duration(8 * 20).EUt(GTValues.VA[GTValues.EV] * 0.8)
    e.recipes.gtceu.assembler().itemInputs('gtceu:iv_machine_hull', '8x gtceu:filter_casing', '4x #gtceu:circuits/luv', '12x #gtceu:circuits/iv', '16x gtceu:iv_electric_pump', '8x gtceu:ev_electric_pump', '16x gtceu:tungsten_steel_normal_fluid_pipe').inputFluids(Fluid.of('gtceu:ethyl_cyanoacrylate', 1000)).itemOutputs('gtceu:clarifier_purification_unit').duration(8 * 20).EUt(GTValues.VA[GTValues.EV] * 0.8).cleanroom(CleanroomType.CLEANROOM)
    e.recipes.gtceu.assembler().itemInputs('16x kubejs:machine_core_4', '4x gtceu:dense_rhodium_plated_palladium_plate', '8x #gtceu:circuits/luv', '3x gtceu:large_chemical_reactor', '3x gtceu:large_chemical_bath', '2x gtceu:large_circuit_assembler', '12x gtceu:iv_robot_arm', '8x gtceu:iv_electric_pump', '8x gtceu:hsss_rotor').inputFluids(Fluid.of('gtceu:ethyl_cyanoacrylate', 1000)).itemOutputs('gtceu:pcb_factory').duration(8 * 20).EUt(GTValues.VA[GTValues.EV] * 0.8)
    e.recipes.gtceu.assembler().itemInputs('gtceu:ev_machine_hull', '3x gtceu:aluminium_single_cable', '2x gtceu:mpic_chip', '2x gtceu:titanium_nitride_ceramic_plate', 'gtceu:ev_voltage_coil').inputFluids(Fluid.of('gtceu:sodium_potassium', 2000)).itemOutputs('gtceu:ev_energy_input_hatch').duration(10 * 20).EUt(GTValues.VA[GTValues.EV] * 0.95).cleanroom(CleanroomType.CLEANROOM)
    e.recipes.gtceu.assembler().itemInputs('gtceu:iv_machine_hull', '3x gtceu:tungsten_single_cable', '2x gtceu:hpic_chip', '2x gtceu:tungsten_tetraboride_ceramic_plate', 'gtceu:iv_voltage_coil').inputFluids(Fluid.of('gtceu:sodium_potassium', 2000)).itemOutputs('gtceu:iv_energy_input_hatch').duration(10 * 20).EUt(GTValues.VA[GTValues.IV] * 0.95).cleanroom(CleanroomType.CLEANROOM)
    e.recipes.gtceu.assembler().itemInputs('4x kubejs:machine_core_4', '2x kubejs:cold_ice_casing', '2x gtceu:black_matter_frame', '4x gtceu:vacuum_freezer', '8x gtceu:zeron_100_gear', '12x #gtceu:circuits/luv', '8x gtceu:iv_field_generator', '8x gtceu:iv_electric_pump', '4x gtceu:iv_electric_piston').inputFluids(Fluid.of('gtceu:sodium_potassium', 2000)).itemOutputs('gtceu:cold_ice_freezer').duration(45 * 20).EUt(GTValues.VA[GTValues.IV]).cleanroom(CleanroomType.CLEANROOM)
    e.recipes.gtceu.assembler().itemInputs('4x kubejs:machine_core_4', '2x kubejs:blaze_casing', '2x gtceu:tungsten_steel_frame', '4x gtceu:electric_blast_furnace', '8x gtceu:molybdenum_disilicide_spring', '12x #gtceu:circuits/luv', '8x gtceu:iv_field_generator', '8x gtceu:iv_electric_pump', '4x gtceu:iv_electric_piston').inputFluids(Fluid.of('gtceu:sodium_potassium', 2000)).itemOutputs('gtceu:blaze_blast_furnace').duration(45 * 20).EUt(GTValues.VA[GTValues.IV])
    e.recipes.gtceu.assembler().itemInputs('gtceu:ev_input_bus', 'ae2:drive', '4x #gtceu:circuits/iv', '4x ae2:cell_component_16k', '8x gtceu:hafnium_plate', '4x gtceu:zirconium_gear', '16x gtceu:vanadium_gallium_spring').inputFluids(Fluid.of('gtceu:ethyl_cyanoacrylate', 1000)).itemOutputs('gtceu:data_access_hatch').duration(45 * 20).EUt(GTValues.VA[GTValues.IV] * 0.43).cleanroom(CleanroomType.CLEANROOM)
    e.recipes.gtceu.assembler().itemInputs('gtceu:wood_drum', '5x gtceu:wrought_iron_plate').itemOutputs('flopper:flopper').EUt(2).duration(40 * 20)
})
