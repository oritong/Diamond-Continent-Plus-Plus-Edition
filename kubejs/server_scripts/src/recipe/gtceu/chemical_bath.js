ServerEvents.recipes(e => {
    ...
    e.recipes.gtceu.chemical_bath().itemInputs('gtceu:borosilicate_glass_ingot').inputFluids(Fluid.of('industrialforegoing:pink_slime', 288)).itemOutputs('industrialforegoing:pink_slime_ingot').EUt(GTValues.VA[GTValues.MV]*0.6).duration(6*20).cleanroom(CleanroomType.CLEANROOM)
})
