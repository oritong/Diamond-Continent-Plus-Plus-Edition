ServerEvents.recipes(e => {
    ...
    e.recipes.gtceu.large_gas_collector().notConsumable('kubejs:nether_data').circuit(1).outputFluids(Fluid.of('gtceu:nether_air', 4250000)).EUt(GTValues.VA[GTValues.EV] * 0.8).duration(120 * 20)
    e.recipes.gtceu.large_gas_collector().notConsumable('kubejs:end_data').circuit(1).outputFluids(Fluid.of('gtceu:ender_air', 3000000)).EUt(GTValues.VA[GTValues.EV]).duration(150 * 20)
