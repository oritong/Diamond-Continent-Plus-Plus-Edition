ServerEvents.recipes(e => {
    ...
    e.recipes.gtceu.laser_engraver().itemInputs('gtceu:silicon_wafer', '#forge:lenses/light_blue').itemOutputs('gtceu:cpu_wafer').duration(45 * 20).EUt(120).cleanroom(CleanroomType.CLEANROOM)
})
