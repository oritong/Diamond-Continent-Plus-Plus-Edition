ServerEvents.recipes(e => {
    e.recipes.gtceu.mixer('oritong:ana_2nd_ender_dust').EUt(28).duration(8 * 20).itemInputs('6x gtceu:lazurite_dust', '4x gtceu:silver_dust', '2x mekanism:dust_diamond', 'gtceu:manasteel_dust').notConsumable('botania:ender_hand').itemOutputs('36x gtceu:ender_pearl_dust').circuit(5).inputFluids(Fluid.of('gtceu:nitrogen', 2000))
