ServerEvents.recipes(e => {
    ...
    e.recipes.gtceu.autoclave().inputFluids(Fluid.of('gtceu:polyethyl_acetate_mixture', 2000)).notConsumable('16x gtceu:cobalt_chloride_dust').notConsumable('16x gtceu:cobalt_acetate_dust').outputFluids(Fluid.of('gtceu:diethyl_malonate', 2000)).EUt(320).duration(6 * 20)
    ...
    e.recipes.gtceu.centrifuge().inputFluids(Fluid.of('gtceu:azeotropic_crude_pyridine', 1000)).outputFluids(Fluid.of('gtceu:refined_crude_pyridine', 550), Fluid.of('minecraft:water', 1000), Fluid.of('gtceu:benzene', 375)).EUt(320).duration(5 * 20)
    e.recipes.gtceu.distillery().inputFluids(Fluid.of('gtceu:refined_crude_pyridine', 1500)).outputFluids(Fluid.of('gtceu:pyridine', 800)).EUt(256).duration(6.5 * 20)
    ...
    e.recipes.gtceu.chemical_reactor().inputFluids(Fluid.of('gtceu:chlorine', 1000)).itemInputs('gtceu:cobalt_dust').itemOutputs('gtceu:cobalt_chloride_dust').EUt(60).duration(4*20)
})
/*
...
2000 聚乙酸乙酯混合液 + 16 氯化钴粉（催化） + 16 醋酸钴粉（催化） → 2000 丙二酸二乙酯 6*20t 320eu 高压釜
