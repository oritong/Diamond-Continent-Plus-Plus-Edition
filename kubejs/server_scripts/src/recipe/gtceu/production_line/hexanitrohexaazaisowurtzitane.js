ServerEvents.recipes(e => {
    e.recipes.gtceu.chemical_reactor().inputFluids(Fluid.of('gtceu:toluene', 1000), Fluid.of('gtceu:chlorine', 1000)).notConsumable('gtceu:blacklight').outputFluids(Fluid.of('gtceu:benzyl_chloride', 1000), Fluid.of('gtceu:hydrochloric_acid', 1000)).EUt(4000).duration(8 * 20)
    e.recipes.gtceu.mixer().inputFluids(Fluid.of('gtceu:formaldehyde', 6000), Fluid.of('gtceu:ammonia_solution', 4000)).itemOutputs('gtceu:hexamethylenetetramine_dust').outputFluids(Fluid.of('minecraft:water', 6000)).EUt(950).duration(6 * 20)
    e.recipes.gtceu.chemical_reactor().itemInputs('gtceu:hexamethylenetetramine_dust').inputFluids(Fluid.of('gtceu:benzyl_chloride', 1000)).itemOutputs('gtceu:benzyl_hexamethylenetetramine_chloride_dust').EUt(1500).duration(7.5 * 20)
    ...
    e.recipes.gtceu.chemical_reactor().inputFluids(Fluid.of('gtceu:benzylamine_hydrochloride', 1000), Fluid.of('gtceu:sodium_hydroxide_solution', 1000)).outputFluids(Fluid.of('gtceu:benzylamine', 1000), Fluid.of('gtceu:salt_water', 1000), Fluid.of('minecraft:water', 1000)).EUt(1200).duration(7.5 * 20)
    ...
    e.recipes.gtceu.vacuum_freezer().itemInputs('9x gtceu:silver_nugget').inputFluids(Fluid.of('gtceu:nitric_acid', 2000)).outputFluids(Fluid.of('gtceu:silver_nitrate', 1000), Fluid.of('gtceu:nitrogen_dioxide', 1000), Fluid.of('minecraft:water', 1000)).EUt(325).duration(325 * 20)
    ...
    e.recipes.gtceu.chemical_plant().itemInputs('gtceu:hexabenzylhexaazaisowurtzitane_dust', 'gtnn:palladium_on_carbon_catalyst').inputFluids(Fluid.of('gtceu:hydrogen', 4000), Fluid.of('gtceu:acetic_anhydride', 4000)).itemOutputs('gtceu:tetraacetyldibenzylhexaazaisowurtzitane_dust').EUt(2000).duration(20 * 5)
    e.recipes.gtceu.chemical_reactor().itemInputs('gtceu:tetraacetyldibenzylhexaazaisowurtzitane_dust').inputFluids(Fluid.of('gtceu:hydrogen', 2000)).itemOutputs('gtceu:tetraacetylhexaazaisowurtzitane_dust').outputFluids(Fluid.of('gtceu:toluene', 2000)).EUt(2600).duration(20 * 5)
    ...
    e.recipes.gtceu.mixer().inputFluids(Fluid.of('gtceu:fuming_nitric_acid', 1000), Fluid.of('gtceu:fuming_sulfuric_acid', 2000)).outputFluids(Fluid.of('gtceu:fuming_nitric_acid_mixture', 2000)).EUt(160).duration(4 * 20)
    e.recipes.gtceu.chemical_reactor().itemInputs('gtceu:tetraacetylhexaazaisowurtzitane_dust').inputFluids(Fluid.of('gtceu:fuming_nitric_acid_mixture', 4000)).itemOutputs('gtceu:hexanitrohexaazaisowurtzitane_dust').outputFluids(Fluid.of('gtceu:acetic_acid', 4000), Fluid.of('gtceu:diluted_sulfuric_acid', 24000)).EUt(32768).duration(20 * 5)
})
/*
