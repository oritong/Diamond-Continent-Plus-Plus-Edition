ServerEvents.recipes(e => {
    ...
    e.recipes.gtceu.large_chemical_reactor().itemInputs('24x minecraft:sugar').inputFluids(Fluid.of('gtceu:nitric_acid', 6000)).notConsumable('gtceu:vanadium_pentoxide_dust').outputFluids(Fluid.of('gtceu:oxalic_acid', 3000), Fluid.of('gtceu:nitric_oxide', 6000)).EUt(120).duration(30 * 20).circuit(1)
