ServerEvents.recipes(e => {
    ...
    e.recipes.gtceu.centrifuge().itemInputs('15x gtceu:deactivated_meteor_precipitate_dust').itemOutputs('8x gtceu:ash_dust', '6x gtceu:silicon_dioxide_dust', '4x ae2:certus_quartz_dust', '2x mekanism:dust_quartz').EUt(8).duration(25 * 20)
