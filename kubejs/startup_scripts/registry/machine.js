...
GTCEuStartupEvents.registry('gtceu:machine', e => {
    ...
    e.create('flocculation_purification_unit', 'multiblock')
        .rotationState(RotationState.NON_Y_AXIS)
        .recipeType('flocculation_purification_unit')
        .appearanceBlock(GTBlocks.CASING_TITANIUM_STABLE)
        .recipeModifiers([GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.OC_NON_PERFECT])
        .pattern(definition => FactoryBlockPattern.start()
            .aisle("   AAA   ", "   AAA   ", "   AAA   ", "   AAA   ", "         ")
            .aisle("  AAAAA  ", "  ACCCA  ", "  ALLLA  ", "  ADDDA  ", "         ")
            .aisle(" AAAAAAA ", " ACEEECA ", " ALLLLLA ", " ADDDDDA ", "         ")
            .aisle("AAAAAAAAA", "ACECCCECA", "ALLLLLLLA", "ADDDDDDDA", "   GGG   ")
            .aisle("AAAAAAAAA", "ACECHCECA", "ALLLHLLLA", "ADDDHDDDA", "GGGGHG   ")
            .aisle("AAAAAAAAA", "ACECCCECA", "ALLLLLLLA", "ADDDDFDDA", "   GGF   ")
            .aisle(" AAAAAAA ", " ACEEECA ", " ALLLLLA ", " ADDDDDA ", "         ")
            .aisle("  AAAAA  ", "  ACCCA  ", "  ALLLA  ", "  ADDDA  ", "         ")
            ...
            .where('G', Predicates.blocks('gtceu:stainless_steel_frame'))
            .where('H', Predicates.blocks('gtceu:assembly_line_grating'))
            .where('L', Predicates.air())
            .build()
        )
        .workableCasingModel('gtceu:block/casings/solid/machine_casing_stable_titanium', 'gtceu:block/multiblock/vacuum_freezer')
